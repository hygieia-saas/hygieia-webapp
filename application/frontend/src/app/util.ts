...
export const defaultRestApiFetch = (path: string, method: 'GET' | 'POST' | 'PUT' | 'OPTIONS' | 'HEAD', defaultRestApiKeyId: null | string = null, body: null | string = null, queryParams: { [key: string]: string } = {}): Promise<Response> => {
